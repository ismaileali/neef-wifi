        ...
        <div class="container">
            <div class="row d-flex justify-content-center">
                <div class="col-md-8">
                    ...
                    ?>
                            <form action="w_users_u_query.php" method="post" enctype="multipart/form-data">
                              <input type="hidden" name="edit_id" value="<?php echo $row['id'] ?>">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for=""><b>Days Remaining</b></label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                       <select name="decibel" id="decibel" class="form-control">
                                          <option selected value="<?php echo $enable; ?>"><?php echo $enable; ?></option>
                                    ...
                                    <div class="btn-group card-body col-md-12 d-flex justify-content-between ">   
                                        ...
                                        <form action="wifi-user-update.php" method="post">
                                            ...
                                            <button type="submit" onclick="return confirm('are you sure ')" name="delete_btn" class="btn btn-danger"> DELETE</button>
                                        </form>
                                     </div>
                                </div>
                            </form>
